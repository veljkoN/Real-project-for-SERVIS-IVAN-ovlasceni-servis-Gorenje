...
import ModalBulevar from './ModalBulevar'
let handleSelectChange:handleSC
let handleSubmit:handleS 
 
const ChangeBulevar:React.FC = () => {
    ...
    return (
        <div className='container'>
            <Helmet>
                <title>GServis-IVAN | Bulevar - promena podataka</title>
            </Helmet>
        <div className='row mt-4'>
            ...
            <div className='col-sm-4 borderColor mb-3 shadow-sm' >
                ...
                <select className="form-control form-control-sm mb-1" onChange={(e) => handleSelectChange(e)} value={selectValue}>
                    ...
                    <option></option>
                    {
                        ...
                        ) : (<input type={selectValue === 'datum' || selectValue === 'sifra'   ? ('text') : ('number')} className="form-control form-control-sm" id='searchInput' placeholder='Unesite vrednost polja' disabled={selectValue ? false : true} />))))
                    }
            ...
            <div className='col-sm-10'>
                <ModalBulevar changeData={changeData} dataPoint={dataPoint} setDataPoint={setDataPoint} setChangeData={setChangeData} setFiltData={setFiltData}/>
            </div>
        </div>  
    </div>
    )
