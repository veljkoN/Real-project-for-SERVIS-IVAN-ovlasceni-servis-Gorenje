...
const statusArray:Array<string> = ['Poručeno', 'Na stanju','Obavešten','Ne javlja se','Prodato']
let msg:Msg
let handleChange:HandleCH
 
const ModalUpdateData:React.FC<PropsCD> = ({changeData, dataPoint, setDataPoint,setChangeData,setFiltData}) => {
    ...
    handleChange = ( e, id ) => {
        ...
        switch (dataPoint) {
            case 'ime': 
                firebase.firestore().collection('uplodedData').doc(id).update({
                    ime: newValue}).then(()=>{ 
                        setInfoError('')
                        setNewValue('')
                    ...
                    <div className="modal-content">
                        ...
                        <div className="modal-body">
                            ...
                            <table className='table table-bordered table-centered'>
                                ...
                                <tbody>
                                    {<tr key={changeData.id} style={changeData.status==='Na stanju' || changeData.status==='Ne javlja se'? (styleSU):(changeData.status==='Obavešten'?(styleSZ):(changeData.status==='Prodato'? (styleG):(undefined)))  }>
